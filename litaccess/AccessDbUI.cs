...
namespace litaccess
{
    internal partial class AccessDbUI : litsdk.ILitUI
    {
        public AccessDbUI()
        {
            InitializeComponent();
            ...
            this.SaveActivity = new Action(() =>
              {
                  sdb.AccessFile = this.tbSqliteFile.Text.Trim();
        ...
        AccessActivity sdb = null;
        public override string ActivityType => "litaccess.AccessActivity";

        public override void SetActivity(Activity activity)
        {
            sdb = activity as AccessActivity;
            this.tbSqliteFile.Text = sdb.AccessFile;
