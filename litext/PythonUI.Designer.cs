namespace litext
{
    partial class PythonUI
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(PythonUI));
            ...
            // smvVarList
            // 
            this.smvVarList.Location = new System.Drawing.Point(116, 9);
            ...
            this.label5.Size = new System.Drawing.Size(531, 39);
            this.label5.TabIndex = 0;
            this.label5.Text = "执行Python代码的原理是将变量转成json字符，通过命令行方式传送给python脚本，Python在执行完后再以json格式输出，再反解回变量值。请使用创建P" +
    "ython文件功能新建脚本。Python可执行程序优先判断当前Python目录下有无python.exe文件，然后检查环境变量。\r\n";
            // 
            // llbSetEnvPath
            // 
            this.llbSetEnvPath.AutoSize = true;
            this.llbSetEnvPath.Location = new System.Drawing.Point(475, 94);
            ...
            // btnTest
            // 
            this.btnTest.Location = new System.Drawing.Point(116, 145);
            ...
            this.cbPyFile.Location = new System.Drawing.Point(118, 51);
            ...
            this.llbOpenDir.Location = new System.Drawing.Point(416, 55);
            ...
            this.Name = "PythonUI";
            this.Load += new System.EventHandler(this.PythonUI_Load);
