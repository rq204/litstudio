...
namespace litsdk
{
    partial class SelectMultVarName
    {
        /// <summary> 
        /// 必需的设计器变量。
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.tsmiClearNot = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.tbVarName.Size = new System.Drawing.Size(117, 21);
            ...
            this.cmsTextBox.Size = new System.Drawing.Size(137, 48);
            // 
            // tsmiClear
            // 
            ...
            this.pbImgPen.Location = new System.Drawing.Point(124, 3);
            ...
            // tsmiClearNot
            // 
            this.tsmiClearNot.Name = "tsmiClearNot";
            this.tsmiClearNot.Size = new System.Drawing.Size(136, 22);
            this.tsmiClearNot.Text = "清除空变量";
            // 
            // SelectMultVarName
            // 
        ...
        public List<string> VarNames
        {
            get
            {
                string txt = this.tbVarName.Text;
                return string.IsNullOrEmpty(txt) ? new List<string>() : txt.Split(',').ToList();
            }
            set
            {
                if (value != null && value.Count > 0) this.tbVarName.Text = string.Join(",", value);
            }
        }
        ...
        private System.Windows.Forms.ToolStripMenuItem tsmiClearNot;
    }
}
